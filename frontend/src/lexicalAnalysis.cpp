...
static bool isKeyWord(const char* word)
{
    ...
    {
        KEY_DON, KEY_ZAMYSEL, KEY_ZAP, KEY_PROPOY, KEY_VOZVRATISHI,
        KEY_POZHERTVUI, KEY_RADI, KEY_KOLI, KEY_DOKOLE, KEY_DA, 
        KEY_PODOBNO, KEY_BUDET, KEY_PRIBUDET, KEY_GLAGOLI, KEY_YASNO, 
        KEY_SQRT, KEY_SIN, KEY_COS, KEY_TG, KEY_LN, KEY_ADD, KEY_SUB, 
        KEY_MUL, KEY_DIV, KEY_EQUAL, KEY_NOT_EQUAL, KEY_GREATER, 
        KEY_LESS, KEY_GREATER_OR_EQUAL, KEY_LESS_OR_EQUAL, KEY_AMIN, 
